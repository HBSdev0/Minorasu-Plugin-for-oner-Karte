...
export function createOperatingCostTab(appData) {
    ...
    const propertyRows = propertyDetails.map((prop, i) => `
        <tr data-prop-index="${i}" data-scenario="current" class="readonly-row">
            ...
            <td><input type="text" id="operatingCostProp_${i}_current_propertyTax" value="${prop.property_tax.value}" readonly></td>
            <td><input type="text" id="operatingCostProp_${i}_current_management" value="${prop.management_fee.value}" readonly></td>
            <td><input type="text" id="operatingCostProp_${i}_current_repair" value="${prop.building_repair_cost.value}" readonly></td>
            <td><input type="text" id="operatingCostProp_${i}_current_restoration" value="${prop.restoration_cost.value}" readonly></td>
            <td><input type="text" id="operatingCostProp_${i}_current_maintenance" value="${prop.maintenance_cost.value}" readonly></td>
            <td><input type="text" id="operatingCostProp_${i}_current_netIncome" value="${prop.net_income.value}" readonly></td>
            <td><input type="text" id="operatingCostProp_${i}_current_fullRent" value="${prop.full_rent.value}" readonly></td>
        ...
        <tr data-prop-index="${i}" data-scenario="forecast">
            ...
            <td><input type="text" id="operatingCostProp_${i}_forecast_propertyTax" value="${prop.property_tax.value}"></td>
            <td><input type="text" id="operatingCostProp_${i}_forecast_management" value="${prop.management_fee.value}"></td>
            <td><input type="text" id="operatingCostProp_${i}_forecast_repair" value="${prop.building_repair_cost.value}"></td>
            <td><input type="text" id="operatingCostProp_${i}_forecast_restoration" value="${prop.restoration_cost.value}"></td>
            <td><input type="text" id="operatingCostProp_${i}_forecast_maintenance" value="${prop.maintenance_cost.value}"></td>
            <td><input type="text" id="operatingCostProp_${i}_forecast_netIncome" value="${prop.net_income.value}"></td>
            <td><input type="text" id="operatingCostProp_${i}_forecast_fullRent" value="${prop.full_rent.value}"></td>
            ...
            <table class="operating-cost-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="operatingCostTblForecastPropertyTax" value="0"></td>
                        <td><input type="text" id="operatingCostTblForecastManagement" value="0"></td>
                        <td><input type="text" id="operatingCostTblForecastRepair" value="0"></td>
                        <td><input type="text" id="operatingCostTblForecastRestoration" value="0"></td>
                        <td><input type="text" id="operatingCostTblForecastMaintenance" value="0"></td>
                        <td><input type="text" id="operatingCostTblForecastNetIncome" value="0"></td>
                        <td><input type="text" id="operatingCostTblForecastFullRent" value="0"></td>
