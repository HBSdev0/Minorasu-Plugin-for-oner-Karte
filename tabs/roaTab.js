...
export function createRoaTab(appData) {
    ...
    const propertyRows = propertyDetails.map((prop, i) => `
        <tr data-prop-index="${i}" data-scenario="current" class="readonly-row">
            ...
            <td>現状</td>
            <td><input type="text" id="roaProp_${i}_current_market" value="${prop.market_price.value}" readonly></td>
            <td><input type="text" id="roaProp_${i}_current_income" value="${prop.income.value}" readonly></td>
            <td><input type="text" id="roaProp_${i}_current_inheritance" value="${prop.inheritance_tax_value.value}" readonly></td>
        ...
        <tr data-prop-index="${i}" data-scenario="forecast">
            <td>試算</td>
            <td><input type="text" id="roaProp_${i}_forecast_market" value="${prop.market_price.value}"></td>
            <td><input type="text" id="roaProp_${i}_forecast_income" value="${prop.income.value}"></td>
            <td><input type="text" id="roaProp_${i}_forecast_inheritance" value="${prop.inheritance_tax_value.value}"></td>
