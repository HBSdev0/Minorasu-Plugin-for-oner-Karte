...
export function createIncomeTaxTab(appData) {
    const { incomeTax: initial, ownerDetails } = appData;
            ...
            <table class="roa-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" id="incomeTaxCurrentRent" value="${ownerDetails.annual_rent.value}" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentManagement" value="${ownerDetails.annual_management_fee.value}" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentLandTax" value="${ownerDetails.land_property_tax.value}" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentBuildingTax" value="${ownerDetails.building_property_tax.value}" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentRepair" value="${ownerDetails.long_term_repair_cost.value}" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentMaintenance" value="${ownerDetails.maintenance_cost.value}" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentInterest" value="${ownerDetails.loan_interest.value}" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentDepreciation" value="${ownerDetails.depreciation.value}" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentInsurance" value="${ownerDetails.annual_insurance_premium.value}" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentIncome" value="0" readonly></td>
                        <td><input type="text" id="incomeTaxCurrentTaxRate" value="0" readonly></td>
                    </tr>
                    <tr>
    ...
    function calculateIncome(rowType) {
        ...
        document.getElementById(`incomeTax${rowType}Income`).value = formatNumber(Math.max(0, income));
